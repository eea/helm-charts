...
1. Matrix homeserver public FQDN - The public url of matrix, used in federation and under which every user is saved; Is used in Element and Identity containers
...
6. Matrix-Element email sender address - Used to send notifications from stack
7. Matrix-Element email sender name - Used to send notifications from stack
8. Matrix https URL - Matrix https URL
9. Element https URL - Element https URL
