...
{{- if .Values.sentryexternal.redis.fullnameOverride -}}
{{- .Values.sentryexternal.redis.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $name := default .Chart.Name .Values.sentryexternal.redis.nameOverride -}}
{{- if contains $name .Release.Name -}}
{{- .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- else -}}
...
{{- if .Values.sentryexternal.postgres.enabled -}}
{{- default 5432 .Values.sentryexternal.postgres.service.port }}
{{- else -}}
...
{{- if .Values.sentryexternal.postgres.enabled -}}
{{- default "" .Values.sentryexternal.postgres.environment.POSTGRES_PASSWORD }}
{{- else -}}
...
{{- if .Values.sentryexternal.redis.enabled -}}
{{  default "" .Values.sentryexternal.redis.password }}
{{- else -}}
